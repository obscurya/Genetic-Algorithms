...
//
//     for (var i = 0; i < genes.length; i++) {
//         sum += Math.abs(target.genes[i] - genes[i]);
//     }
//
//     fitness.push(sum);
//
...
function generate() {
    ...
    // var k = Math.pow(10, String(fitness[0]).length);
    //
    // for (var i = 0; i < faces.length; i++) {
    //     for (var j = 0; j < Math.floor(faces[i].fitness * k); j++) {
    //         pool.push(faces[i]);
    //     }
    // }
...
function draw() {
    ...
    c.fillStyle = '#000';
    c.font = '14px sans-serif';
    c.fillText('Generation: ' + generation, chunks[1], ratio);
    c.closePath();
}
